 ...
 * 创建时间：2017/8/29
 * 描述：自定义的布局，用来管理三个子控件，其中一个是下拉头，一个是包含内容的pullableView（可以是实现Pullable接口的的任何View），
*/
public class PullToRefreshLayout extends RelativeLayout {
     ...
     * 不限制上拉或下拉
     */
    public void releasePull(boolean down,boolean up) {

        this.down = down;
        this.up = up;
    }
    public void releasePull2() {
        this.canPullDown=down;
        this.canPullUp=up;
    }
