...
import com.zhubaokeji.android.widget.StatusView;

/**
 * Created by Administrator on 2016/10/19.
 */

public class StatusLayoutFragment extends FrameLayout {
    ...
    public static StatusLayoutFragment getInstance(View view, StatusView statusView) {
        return new StatusLayoutFragment.Builder().setContentView(view).setStatusView(statusView).build();
    }

    public static StatusLayoutFragment getInstance(Activity activity, StatusView statusView) {
        return new StatusLayoutFragment.Builder().setContentView(activity).setStatusView(statusView).build();
    }

    public static StatusLayoutFragment getInstance(Fragment fragment, StatusView statusView) {
        return new StatusLayoutFragment.Builder().setContentView(fragment).setStatusView(statusView).build();
    }

    public StatusLayoutFragment(Context context) {
        super(context);
        this.context = context;

    }

    public StatusLayoutFragment(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public StatusLayoutFragment(Context context, AttributeSet attrs, int defStyle) {
    ...
    public StatusLayoutFragment setStatusView(StatusView mStatusView) {
     ...
     * @return
     */
    public StatusLayoutFragment setLoadingView() {
     ...
     * @return
     */
    public StatusLayoutFragment setRetryView() {
     ...
     * @return
     */
    public StatusLayoutFragment setEmptyView() {
     ...
     * @return
     */
    public StatusLayoutFragment setSettingView() {
    ...
    public static final class Builder {
        ...
        private View mContentView;// 正常的内容页面
        private StatusLayoutFragment statusLayout;
        ...
        public StatusLayoutFragment build() {
            View view = mParentView.getChildAt(index);
            // 父类本分就是StatusLayout
            if (mParentView != null && mParentView instanceof StatusLayoutFragment) {
                statusLayout = (StatusLayoutFragment) mParentView;
            }
            // 内容本分就是StatusLayout
            else if (view != null && view instanceof StatusLayoutFragment) {
                statusLayout = (StatusLayoutFragment) view;
            }
            // 其他情况
            else {
                mContentView = view;
                statusLayout = new StatusLayoutFragment(
