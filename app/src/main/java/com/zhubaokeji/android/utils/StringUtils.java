...
public class StringUtils {
    ...
    public static String toString(Intent intent) {
        ...
        if (intent != null) {
            ...
            String categories = StringUtils.toString((Intent) intent.getCategories());
...
//                String key = URLDecoder.decode(pair[0], String.valueOf(Charsets.UTF_8));
//                if (pair.length > 1) {
//                    String value = URLDecoder.decode(pair[1], String.valueOf(Charsets.UTF_8));
